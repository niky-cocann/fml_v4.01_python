    ...
    while True:
        ...
        if display_type.value==fml_enums.FMLDisplayType.TANK_LEVEL.value:
            ...
            if ohms in fml_globals.tank_params_dict.keys():
                display_value = round(fml_globals.tank_params_dict[ohms])
            else:
                if ohms<min(fml_globals.tank_params_dict.keys()):
                    display_value = round(fml_globals.tank_params_dict[min(fml_globals.tank_params_dict.keys())])
                elif ohms>max(fml_globals.tank_params_dict.keys()):
                    display_value = round(fml_globals.tank_params_dict[max(fml_globals.tank_params_dict.keys())])
                else:
